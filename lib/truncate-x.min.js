 ...
 * @module truncate-x
 */
"use strict";var isUndefined=_dereq_("validate.io-undefined"),toLength=_dereq_("to-length-x"),isRegExp=_dereq_("is-regex"),safeToString=_dereq_("safe-to-string-x"),isObjectLike=_dereq_("is-object-like-x"),reFlags=/\w*$/,rsCombo="[\\u0300-\\u036f\\ufe20-\\ufe23\\u20d0-\\u20f0]",rsFitz="\\ud83c[\\udffb-\\udfff]",rsRegional="(?:\\ud83c[\\udde6-\\uddff]){2}",rsSurrPair="[\\ud800-\\udbff][\\udc00-\\udfff]",reOptMod="(?:[\\u0300-\\u036f\\ufe20-\\ufe23\\u20d0-\\u20f0]|\\ud83c[\\udffb-\\udfff])?",rsSeq="[\\ufe0e\\ufe0f]?"+reOptMod+("(?:\\u200d(?:"+["[^\\ud800-\\udfff]",rsRegional,rsSurrPair].join("|")+")[\\ufe0e\\ufe0f]?"+reOptMod+")*"),rsSymbol="(?:"+["[^\\ud800-\\udfff]"+rsCombo+"?",rsCombo,rsRegional,rsSurrPair,"[\\ud800-\\udfff]"].join("|")+")",reComplexSymbol=new RegExp(rsFitz+"(?="+rsFitz+")|"+rsSymbol+rsSeq,"g"),reHasComplexSymbol=new RegExp("[\\u200d\\ud800-\\udfff\\u0300-\\u036f\\ufe20-\\ufe23\\u20d0-\\u20f0\\ufe0e\\ufe0f]"),stringSize=function _stringSize(string){if(!1===Boolean(string)||!1===reHasComplexSymbol.test(string))return string.length;reComplexSymbol.lastIndex=0;for(var result=0;reComplexSymbol.test(string);)result+=1;return result};module.exports=function truncate(string,options){var separator,str=safeToString(string),length=30,omission="...";isObjectLike(options)&&("separator"in options&&(separator=options.separator),"length"in options&&(length=toLength(options.length)),"omission"in options&&(omission=safeToString(options.omission)));var matchSymbols,strLength=str.length;if(reHasComplexSymbol.test(str)&&(strLength=(matchSymbols=str.match(reComplexSymbol)).length),length>=strLength)return str;var end=length-stringSize(omission);if(end<1)return omission;var result=matchSymbols?matchSymbols.slice(0,end).join(""):str.slice(0,end);if(isUndefined(separator))return result+omission;if(matchSymbols&&(end+=result.length-end),isRegExp(separator)){if(str.slice(end).search(separator)){var substr=result;!1===Boolean(separator.global)&&(separator=new RegExp(separator.source,safeToString(reFlags.exec(separator))+"g")),separator.lastIndex=0;for(var newEnd,match=separator.exec(substr);match;)newEnd=match.index,match=separator.exec(substr);result=result.slice(0,isUndefined(newEnd)?end:newEnd)}}else if(str.indexOf(separator,end)!==end){var index=result.lastIndexOf(separator);index>-1&&(result=result.slice(0,index))}return result+omission}},{"is-object-like-x":17,"is-regex":19,"safe-to-string-x":30,"to-length-x":32,"validate.io-undefined":40}],2:[function(_dereq_,module,exports){"use strict";var keys=_dereq_("object-keys"),foreach=_dereq_("foreach"),hasSymbols="function"==typeof Symbol&&"symbol"==typeof Symbol(),toStr=Object.prototype.toString,isFunction=function(fn){return"function"==typeof fn&&"[object Function]"===toStr.call(fn)},supportsDescriptors=Object.defineProperty&&function(){var obj={};try{Object.defineProperty(obj,"x",{enumerable:!1,value:obj});for(var _ in obj)return!1;return obj.x===obj}catch(e){return!1}}(),defineProperty=function(object,name,value,predicate){(!(name in object)||isFunction(predicate)&&predicate())&&(supportsDescriptors?Object.defineProperty(object,name,{configurable:!0,enumerable:!1,value:value,writable:!0}):object[name]=value)},defineProperties=function(object,map){var predicates=arguments.length>2?arguments[2]:{},props=keys(map);hasSymbols&&(props=props.concat(Object.getOwnPropertySymbols(map))),foreach(props,function(name){defineProperty(object,name,map[name],predicates[name])})};defineProperties.supportsDescriptors=!!supportsDescriptors,module.exports=defineProperties},{foreach:3,"object-keys":26}],3:[function(_dereq_,module,exports){var hasOwn=Object.prototype.hasOwnProperty,toString=Object.prototype.toString;module.exports=function forEach(obj,fn,ctx){if("[object Function]"!==toString.call(fn))throw new TypeError("iterator must be a function");var l=obj.length;if(l===+l)for(var i=0;i<l;i++)fn.call(ctx,obj[i],i,obj);else for(var k in obj)hasOwn.call(obj,k)&&fn.call(ctx,obj[k],k,obj)}},{}],4:[function(_dereq_,module,exports){"use strict";var slice=Array.prototype.slice,toStr=Object.prototype.toString;module.exports=function bind(that){var target=this;if("function"!=typeof target||"[object Function]"!==toStr.call(target))throw new TypeError("Function.prototype.bind called on incompatible "+target);for(var bound,args=slice.call(arguments,1),boundLength=Math.max(0,target.length-args.length),boundArgs=[],i=0;i<boundLength;i++)boundArgs.push("$"+i);if(bound=Function("binder","return function ("+boundArgs.join(",")+"){ return binder.apply(this,arguments); }")(function(){if(this instanceof bound){var result=target.apply(this,args.concat(slice.call(arguments)));return Object(result)===result?result:this}return target.apply(that,args.concat(slice.call(arguments)))}),target.prototype){var Empty=function Empty(){};Empty.prototype=target.prototype,bound.prototype=new Empty,Empty.prototype=null}return bound}},{}],5:[function(_dereq_,module,exports){"use strict";var implementation=_dereq_("./implementation");module.exports=Function.prototype.bind||implementation},{"./implementation":4}],6:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var $isFinite,nativeNumberIsFinite="function"==typeof Number.isFinite&&Number.isFinite;if(nativeNumberIsFinite)try{nativeNumberIsFinite(_dereq_("max-safe-integer"))&&!1===nativeNumberIsFinite(Infinity)&&($isFinite=Number.isFinite)}catch(ignore){}if(!1===Boolean($isFinite)){var $isNaN=_dereq_("is-nan");$isFinite=function isFinite(number){return"number"==typeof number&&!1===$isNaN(number)&&number!==Infinity&&number!==-Infinity}}module.exports=$isFinite},{"is-nan":13,"max-safe-integer":24}],11:[function(_dereq_,module,exports){/**
 ...
 * @module is-nil-x
 */
"use strict";var isUndefined=_dereq_("validate.io-undefined"),isNull=_dereq_("lodash.isnull");module.exports=function isNil(value){return isNull(value)||isUndefined(value)}},{"lodash.isnull":22,"validate.io-undefined":40}],17:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":20}],29:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":16}],30:[function(_dereq_,module,exports){/**
 ...
 * @module to-integer-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan"),numberIsFinite=_dereq_("is-finite-x"),mathSign=_dereq_("math-sign-x");module.exports=function ToInteger(value){var number=toNumber(value);return numberIsNaN(number)?0:0===number||!1===numberIsFinite(number)?number:mathSign(number)*Math.floor(Math.abs(number))}},{"is-finite-x":10,"is-nan":13,"math-sign-x":23,"to-number-x":33}],32:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function ToLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":24,"to-integer-x":31}],33:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":22,"validate.io-undefined":40}],36:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":21}],37:[function(_dereq_,module,exports){/**
 ...
 * @module trim-left-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reLeft=new RegExp("^["+_dereq_("white-space-x").string+"]+");module.exports=function trimLeft(string){return $toString(string).replace(reLeft,"")}},{"to-string-x":36,"white-space-x":41}],38:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reRight=new RegExp("["+_dereq_("white-space-x").string+"]+$");module.exports=function trimRight(string){return $toString(string).replace(reRight,"")}},{"to-string-x":36,"white-space-x":41}],39:[function(_dereq_,module,exports){/**
