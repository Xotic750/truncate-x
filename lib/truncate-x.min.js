 ...
 * @module truncate-x
 */
"use strict";var isUndefined=_dereq_("validate.io-undefined"),toLength=_dereq_("to-length-x"),isRegExp=_dereq_("is-regexp-x"),safeToString=_dereq_("safe-to-string-x"),isObjectLike=_dereq_("is-object-like-x"),isFalsey=_dereq_("is-falsey-x"),hasOwn=_dereq_("has-own-property-x"),arraySlice=_dereq_("array-slice-x"),sMatch=String.prototype.match,sSlice=String.prototype.slice,sSearch=String.prototype.search,sIndexOf=String.prototype.indexOf,sLastIndexOf=String.prototype.lastIndexOf,aJoin=Array.prototype.join,Rx=RegExp,reFlags=/\w*$/,rxTest=reFlags.test,rxExec=reFlags.exec,rsCombo="[\\u0300-\\u036f\\ufe20-\\ufe23\\u20d0-\\u20f0]",rsFitz="\\ud83c[\\udffb-\\udfff]",rsRegional="(?:\\ud83c[\\udde6-\\uddff]){2}",rsSurrPair="[\\ud800-\\udbff][\\udc00-\\udfff]",reOptMod="(?:[\\u0300-\\u036f\\ufe20-\\ufe23\\u20d0-\\u20f0]|\\ud83c[\\udffb-\\udfff])?",rsSeq="[\\ufe0e\\ufe0f]?"+reOptMod+("(?:\\u200d(?:"+aJoin.call(["[^\\ud800-\\udfff]",rsRegional,rsSurrPair],"|")+")[\\ufe0e\\ufe0f]?"+reOptMod+")*"),rsSymbol="(?:"+aJoin.call(["[^\\ud800-\\udfff]"+rsCombo+"?",rsCombo,rsRegional,rsSurrPair,"[\\ud800-\\udfff]"],"|")+")",reComplexSymbol=new Rx(rsFitz+"(?="+rsFitz+")|"+rsSymbol+rsSeq,"g"),reHasComplexSymbol=new Rx("[\\u200d\\ud800-\\udfff\\u0300-\\u036f\\ufe20-\\ufe23\\u20d0-\\u20f0\\ufe0e\\ufe0f]"),stringSize=function _stringSize(string){if(isFalsey(string)||!1===rxTest.call(reHasComplexSymbol,string))return string.length;reComplexSymbol.lastIndex=0;for(var result=0;rxTest.call(reComplexSymbol,string);)result+=1;return result};module.exports=function truncate(string,options){var separator,str=safeToString(string),length=30,omission="...";isObjectLike(options)&&(hasOwn(options,"separator")&&(separator=options.separator),hasOwn(options,"length")&&(length=toLength(options.length)),hasOwn(options,"omission")&&(omission=safeToString(options.omission)));var matchSymbols,strLength=str.length;if(rxTest.call(reHasComplexSymbol,str)&&(strLength=(matchSymbols=sMatch.call(str,reComplexSymbol)).length),length>=strLength)return str;var end=length-stringSize(omission);if(end<1)return omission;var result=matchSymbols?aJoin.call(arraySlice(matchSymbols,0,end),""):sSlice.call(str,0,end);if(isUndefined(separator))return result+omission;if(matchSymbols&&(end+=result.length-end),isRegExp(separator)){if(sSearch.call(sSlice.call(str,end),separator)){var substr=result;isFalsey(separator.global)&&(separator=new Rx(separator.source,safeToString(rxExec.call(reFlags,separator))+"g")),separator.lastIndex=0;for(var newEnd,match=rxExec.call(separator,substr);match;)newEnd=match.index,match=rxExec.call(separator,substr);result=sSlice.call(result,0,isUndefined(newEnd)?end:newEnd)}}else if(sIndexOf.call(str,separator,end)!==end){var index=sLastIndexOf.call(result,separator);index>-1&&(result=sSlice.call(result,0,index))}return result+omission}},{"array-slice-x":3,"has-own-property-x":7,"is-falsey-x":13,"is-object-like-x":19,"is-regexp-x":21,"safe-to-string-x":34,"to-length-x":37,"validate.io-undefined":47}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsObject(value){if(isPrimitive(value))throw new TypeError(safeToString(value)+" is not an object");return value}},{"is-primitive":20,"safe-to-string-x":34}],5:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),toPropertyKey=_dereq_("to-property-key-x"),hop=Object.prototype.hasOwnProperty;module.exports=function hasOwnProperty(object,property){return hop.call(toObject(object),toPropertyKey(property))}},{"to-object-x":39,"to-property-key-x":41}],8:[function(_dereq_,module,exports){/**
 ...
 * @module is-falsey-x
 */
"use strict";module.exports=function isFalsey(value){return!1===Boolean(value)}},{}],14:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==1/0&&number!==-1/0}},{"is-nan-x":17}],15:[function(_dereq_,module,exports){/**
 ...
 * @module is-nan-x
 */
"use strict";module.exports=function isNaN(value){return value!==value}},{}],18:[function(_dereq_,module,exports){/**
 ...
 * @module is-nil-x
 */
"use strict";var isUndefined=_dereq_("validate.io-undefined"),isNull=_dereq_("lodash.isnull");module.exports=function isNil(value){return isNull(value)||isUndefined(value)}},{"lodash.isnull":24,"validate.io-undefined":47}],19:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),isPrimitive=_dereq_("is-primitive");module.exports=function isObjectLike(value){return!1===isPrimitive(value)&&!1===isFunction(value,!0)}},{"is-function-x":15,"is-primitive":20}],20:[function(_dereq_,module,exports){"use strict";module.exports=function isPrimitive(value){return null==value||"function"!=typeof value&&"object"!=typeof value}},{}],21:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":17,"to-number-x":38}],27:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],28:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":46,"white-space-x":48}],29:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":22}],33:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":18}],34:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function toLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":27,"to-integer-x":36}],38:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function toObject(value){return Object(requireObjectCoercible(value))}},{"require-object-coercible-x":33}],40:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var hasSymbols=_dereq_("has-symbol-support-x"),toPrimitive=_dereq_("to-primitive-x"),toStr=_dereq_("to-string-x");module.exports=function toPropertyKey(argument){var key=toPrimitive(argument,String);return hasSymbols&&"symbol"==typeof key?key:toStr(key)}},{"has-symbol-support-x":8,"to-primitive-x":40,"to-string-x":43}],42:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":23}],44:[function(_dereq_,module,exports){/**
 ...
 * @module trim-left-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reLeft=new RegExp("^["+_dereq_("white-space-x").string+"]+");module.exports=function trimLeft(string){return $toString(string).replace(reLeft,"")}},{"to-string-x":43,"white-space-x":48}],45:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reRight=new RegExp("["+_dereq_("white-space-x").string+"]+$");module.exports=function trimRight(string){return $toString(string).replace(reRight,"")}},{"to-string-x":43,"white-space-x":48}],46:[function(_dereq_,module,exports){/**
